...
exports.CreateCelebrateDTO = void 0;
const swagger_1 = require("@nestjs/swagger");
const class_validator_1 = require("class-validator");
class CreateCelebrateDTO {
    tripId;
    date;
    description;
    images;
}
exports.CreateCelebrateDTO = CreateCelebrateDTO;
__decorate([
    (0, swagger_1.ApiProperty)({ example: "trip-uuid" }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: "Tuyet voi " }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
